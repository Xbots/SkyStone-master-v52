...
@Autonomous(name = "Xplorer: Crater for States (WITH DOUBLE SAMPLING)", group = "Xplorer")
public class XplorerCraterAutonomousDoubleSampling extends XplorerCommon {
