...
@Autonomous(name = "Xplorer: Crater No Wall Sensing", group = "Xplorer")
public class XplorerCraterAutonomousNoSensing extends XplorerCommon {
    ...
    public void runOpMode() {
        ...
        escapeLatch();
        sampleGoldCraterNoSensing(finalPos, d);  //Samples and ready to drop Team Marker
